            ...
            <div className="result-pages__header-navigation">
                <div className="rp-header-navigation header-navigation__container">
                    ...
                    <div className="header-navigation--item is-actived">
                        <NavLink activeClassName={this.styles.isActive} className="hn-item--text" to="/result">Tất cả</NavLink>
                    </div>
                    <div className="header-navigation--item">
                        <NavLink activeClassName={this.styles.isActive} className="hn-item--text" to="/result/posts">Thông tin</NavLink>
                    </div>
                    <div className="header-navigation--item">
                        <NavLink activeClassName={this.styles.isActive} className="hn-item--text" to="/ban-do">Bản đồ</NavLink>
                    </div>
                    <div className="header-navigation--item">
